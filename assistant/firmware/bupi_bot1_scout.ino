...
void loop() {
  ...
  if (now - lastSensorTick >= 50) {
    ...
    // Immediate event transmission if obstacle state or movement state changed
    static String lastMovementSent = "STOP";
    bool stateChanged = (currentMovement != lastMovementSent) || (obstacleCritical != prevCritical);
